...
namespace WebAPI_Client
{
    public partial class Form1 : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            //Serializa parametro em json
            MemoryStream stream = new MemoryStream();
            DataContractJsonSerializer jsonSer = new DataContractJsonSerializer(typeof(int));
            jsonSer.WriteObject(stream, model);
            stream.Position = 0;
        ...
        {
            //https://localhost:44355/api/History/newIndicador
            ...
            //Definir tipo de dados no pedido: JSON
            client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));

            //Parâmetro em JSON

            //var payload = "{\"date\": 5,\"infetados\": \"Pepsi\"}";
            ...
            //Serializa em json
            MemoryStream stream = new MemoryStream();
            DataContractJsonSerializer jsonSer = new DataContractJsonSerializer(typeof(Indicador));
            jsonSer.WriteObject(stream, ind);
            stream.Position = 0;
            StreamReader sr = new StreamReader(stream);
            string jsonString = sr.ReadToEnd();
